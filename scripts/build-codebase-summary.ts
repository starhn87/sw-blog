...
function buildSummary() {
  ...
  if (fs.existsSync(path.join(ROOT, "src/lib/image.ts"))) features.push("이미지 최적화 (Cloudflare Image Transformations: format=auto 브라우저 협상, responsive srcset, zoom URL이 srcset 최대값과 캐시 공유)");
