...
```ts
// packages/next/src/server/route-matcher-managers/default-route-matcher-manager.ts
...
class UrlNode {
  constructor() {
    ...
    this.slugName = null;             // [slug]     : 자식 키는 '[]'
    this.restSlugName = null;         // [...slug]  : 자식 키는 '[...]'
    this.optionalRestSlugName = null; // [[...slug]]: 자식 키는 '[[...]]'
  }
...
```ts
// packages/next/src/shared/lib/router/utils/interception-routes.ts
